...
import { Building, Building2, ExternalLink, LayoutDashboard, Loader2 } from "lucide-react";
import Link from "next/link";
import { useTranslations } from "next-intl";
import useGetOrganizerBusinesses from "@/hooks/business/useGetOrganizerBusinesses";
import { BusinessListSkeleton } from "./Skeletons";
...
export default function BusinessList({
  ...
  } = useGetOrganizerBusinesses(organizerId);
